    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-secondary">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart('banner/simpan'); ?>

                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="gambar">Upload banner </label>
                    <div class="col-md-9">
                        <div class="input-group">

                            <input value="<?= set_value('gambar'); ?>" name="gambar" id="gambar" type="file" placeholder="Masukann gambar..." required>
