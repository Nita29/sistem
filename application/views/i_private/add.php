    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-secondary">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart('i_private/add'); ?>
                ...
                <!-- <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="kode_dokumen">Kode dokumen</label>
                        ...
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('kode_dokumen') ?>" name="kode_dokumen" readonly="readonly" id="kode_dokumen" type="text" class="form-control">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('judul'); ?>" name="judul" id="judul" type="text" class="form-control" placeholder="Masukann judul ..." required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('tahun'); ?>" name="tahun" id="tahun" type="text" class="form-control" placeholder="Masukann tahun ..." required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('deskripsi'); ?>" name="deskripsi" id="deskripsi" type="text" class="form-control" placeholder="Masukann deskripsi ..." required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('tipe'); ?>" name="tipe" id="tipe" type="text" class="form-control" placeholder="Masukann tipe ..." required>
                        </div>
