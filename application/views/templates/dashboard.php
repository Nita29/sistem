...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav   bg-gradient-light sidebar sidebar-light  accordion shadow-md" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <!-- <a class="collapse-item" href="<?= base_url('berita_regulasi'); ?>">Regulasi</a> -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary btn-darken-2" type="button" data-dismiss="modal">Batalkan</button>
    ...
    <?php if ($this->uri->segment(1) == 'dashboard') : ?>
        ...
        <script type="text/javascript">
            ...
            //         datasets: [{
            //                 label: "Total Permohonan informasi",
            //                 lineTension: 0.3,
            ...
            var myPieChart = new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ["Permohonan informasi", "Balas informasi "],
                    datasets: [{
                        data: [<?= $permohonan; ?>, <?= $balas; ?>],
                        backgroundColor: ['#33D67C', '#e74a3b'],
                        hoverBackgroundColor: ['#177240', '#C01819'],
