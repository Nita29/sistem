    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-secondary">
            ...
            <div class="card-body">
                ...
                <?= form_open_multipart('', [], ['id_berkala' => $i_berkala['id_berkala']]); ?>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('kode_dokumen', $i_berkala['kode_dokumen']); ?>" name="kode_dokumen" id="kode_dokumen" readonly type="text" class="form-control" placeholder="Masukan kode dokumen...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('judul', $i_berkala['judul']); ?>" name="judul" id="judul" type="text" class="form-control" placeholder="Nomor Telepon...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('tahun', $i_berkala['tahun']); ?>" name="tahun" id="tahun" type="text" class="form-control" placeholder="Nomor Telepon...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= set_value('tanggal_masuk', $i_berkala['tanggal_masuk'], date('Y-m-d')); ?>" name="tanggal_masuk" id="tanggal_masuk" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('deskripsi', $i_berkala['deskripsi']); ?>" name="deskripsi" id="deskripsi" type="text" class="form-control" placeholder="Nomor Telepon...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('tipe', $i_berkala['tipe']); ?>" name="tipe" id="tipe" type="text" class="form-control" placeholder="Nomor Telepon...">
                        </div>
